...
#define CLSID_OBJECT_W_BIPODS MK_CLSID('W', '_', 'B', 'I', 'P', 'O', 'D', 'S')
#define CLSID_OBJECT_W_CHARGS MK_CLSID('W', '_', 'C', 'H', 'A', 'R', 'G', 'S')
#define CLSID_OBJECT_W_CHARGH MK_CLSID('W', '_', 'C', 'H', 'A', 'R', 'G', 'H')
#define CLSID_OBJECT_W_FLIGHT MK_CLSID('W', '_', 'F', 'L', 'I', 'G', 'H', 'T')
#define CLSID_OBJECT_W_FGRIPS MK_CLSID('W', '_', 'F', 'G', 'R', 'I', 'P', 'S')
#define CLSID_OBJECT_W_GBLOCK MK_CLSID('W', '_', 'G', 'B', 'L', 'O', 'C', 'K')
#define CLSID_OBJECT_W_HGUARD MK_CLSID('W', '_', 'H', 'G', 'U', 'A', 'R', 'D')
#define CLSID_OBJECT_W_MAGAZN MK_CLSID('W', '_', 'M', 'A', 'G', 'A', 'Z', 'N')
#define CLSID_OBJECT_W_MOUNTS MK_CLSID('W', '_', 'M', 'O', 'U', 'N', 'T', 'S')
#define CLSID_OBJECT_W_MUZZLE MK_CLSID('W', '_', 'M', 'U', 'Z', 'Z', 'L', 'E')
#define CLSID_OBJECT_W_RCIEVR MK_CLSID('W', '_', 'R', 'C', 'I', 'E', 'V', 'R')
#define CLSID_OBJECT_W_SIGHTS MK_CLSID('W', '_', 'S', 'I', 'G', 'H', 'T', 'S')
#define CLSID_OBJECT_W_SIGHTF MK_CLSID('W', '_', 'S', 'I', 'G', 'H', 'T', 'F')
#define CLSID_OBJECT_W_SIGHTR MK_CLSID('W', '_', 'S', 'I', 'G', 'H', 'T', 'R')
#define CLSID_OBJECT_W_SIGHT2 MK_CLSID('W', '_', 'S', 'I', 'G', 'H', 'T', '2')
#define CLSID_OBJECT_W_STOCKS MK_CLSID('W', '_', 'S', 'T', 'O', 'C', 'K', 'S')
#define CLSID_OBJECT_W_TACTI1 MK_CLSID('W', '_', 'T', 'A', 'C', 'T', 'I', '1')
#define CLSID_OBJECT_W_ADAPT1 MK_CLSID('W', '_', 'A', 'D', 'A', 'P', 'T', '1')
#define CLSID_OBJECT_W_ADAPT2 MK_CLSID('W', '_', 'A', 'D', 'A', 'P', 'T', '2')
#define CLSID_OBJECT_W_LASERR MK_CLSID('W', '_', 'L', 'A', 'S', 'E', 'R', 'R')
