...
class_<CScriptGameObject>& script_register_game_object2(class_<CScriptGameObject>& instance)
{
    instance
        ...
        .def("weapon_is_Barrel", &CScriptGameObject::Weapon_IsBarrelAttached)
        .def("weapon_is_Chargs", &CScriptGameObject::Weapon_IsChargsAttached)
        .def("weapon_is_Bipods", &CScriptGameObject::Weapon_IsBipodsAttached)
        .def("weapon_is_Chargh", &CScriptGameObject::Weapon_IsCharghAttached)
        .def("weapon_is_Flight", &CScriptGameObject::Weapon_IsFlightAttached)
        .def("weapon_is_Gblock", &CScriptGameObject::Weapon_IsGblockAttached)
        .def("weapon_is_Hguard", &CScriptGameObject::Weapon_IsHguardAttached)
        .def("weapon_is_Magazn", &CScriptGameObject::Weapon_IsMagaznAttached)
        .def("weapon_is_Mounts", &CScriptGameObject::Weapon_IsMountsAttached)
        .def("weapon_is_Muzzle", &CScriptGameObject::Weapon_IsMuzzleAttached)
        .def("weapon_is_Rcievr", &CScriptGameObject::Weapon_IsRcievrAttached)
        .def("weapon_is_Sights", &CScriptGameObject::Weapon_IsSightsAttached)
        .def("weapon_is_Sightf", &CScriptGameObject::Weapon_IsSightfAttached)
        .def("weapon_is_Sightr", &CScriptGameObject::Weapon_IsSightrAttached)
        .def("weapon_is_Sight2", &CScriptGameObject::Weapon_IsSight2Attached)
        .def("weapon_is_Stocks", &CScriptGameObject::Weapon_IsStocksAttached)
        .def("weapon_is_Tacti1", &CScriptGameObject::Weapon_IsTacti1Attached)
        .def("weapon_is_Adapt1", &CScriptGameObject::Weapon_IsAdapt1Attached)
        .def("weapon_is_Adapt2", &CScriptGameObject::Weapon_IsAdapt2Attached)
        .def("weapon_is_Laserr", &CScriptGameObject::Weapon_IsLaserrAttached)
        ...
        .def("weapon_is_Fgrips_status", &CScriptGameObject::Weapon_Fgrips_Status)
        .def("weapon_is_Barrel_status", &CScriptGameObject::Weapon_Barrel_Status)
        .def("weapon_is_Chargs_status", &CScriptGameObject::Weapon_Chargs_Status)
        .def("weapon_is_Bipods_status", &CScriptGameObject::Weapon_Bipods_Status)
        .def("weapon_is_Chargh_status", &CScriptGameObject::Weapon_Chargh_Status)
        .def("weapon_is_Flight_status", &CScriptGameObject::Weapon_Flight_Status)
        .def("weapon_is_Gblock_status", &CScriptGameObject::Weapon_Gblock_Status)
        .def("weapon_is_Hguard_status", &CScriptGameObject::Weapon_Hguard_Status)
        .def("weapon_is_Magazn_status", &CScriptGameObject::Weapon_Magazn_Status)
        .def("weapon_is_Mounts_status", &CScriptGameObject::Weapon_Mounts_Status)
        .def("weapon_is_Muzzle_status", &CScriptGameObject::Weapon_Muzzle_Status)
        .def("weapon_is_Rcievr_status", &CScriptGameObject::Weapon_Rcievr_Status)
        .def("weapon_is_Sights_status", &CScriptGameObject::Weapon_Sights_Status)
        .def("weapon_is_Sightf_status", &CScriptGameObject::Weapon_Sightf_Status)
        .def("weapon_is_Sightr_status", &CScriptGameObject::Weapon_Sightr_Status)
        .def("weapon_is_Sight2_status", &CScriptGameObject::Weapon_Sight2_Status)
        .def("weapon_is_Stocks_status", &CScriptGameObject::Weapon_Stocks_Status)
        .def("weapon_is_Tacti1_status", &CScriptGameObject::Weapon_Tacti1_Status)
        .def("weapon_is_Adapt1_status", &CScriptGameObject::Weapon_Adapt1_Status)
        .def("weapon_is_Adapt2_status", &CScriptGameObject::Weapon_Adapt2_Status)
        .def("weapon_is_Laserr_status", &CScriptGameObject::Weapon_Laserr_Status)
